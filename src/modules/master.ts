...
export const getProject = (state: MasterState, id: string) =>
  find(propEq("projectId", id), state.projects);
export const getUsage = (state: MasterState, id: string) =>
  find(propEq("usageId", id), state.usages);
export const getObjective = (state: MasterState, id: string) =>
  find(propEq("objectiveId", id), state.objectives);
